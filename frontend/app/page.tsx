...
export default function Home() {
	...
	return (
		<div className="app-shell antialiased text-foreground">
			...
			<section
				className="main-panel animate-in"
			...
			>
				...
				{activeRoom?.kind === "stream" ? (
					<div className="shrink-0">
						<StreamExperience
							canManageCurrentRoomStream={canManageCurrentRoomStream}
							currentRoomStream={
								currentRoomStream
									? { id: currentRoomStream.id, live: currentRoomStream.live }
									: null
							}
							knownStreamHostId={knownStreamHostId}
							liveStreamTitle={liveStreamForActiveRoom?.title ?? null}
							obsConfig={streamObsConfig}
							onDeleteCurrentRoomStream={handleDeleteCurrentRoomStream}
							...
							onResetCurrentRoomStream={handleResetCurrentRoomStream}
