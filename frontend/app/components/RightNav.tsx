...
export function RightNav({
  ...
  return (
    <aside className="right-panel animate-in" style={{ animationDelay: "250ms" }}>
      {/* Profile Card */}
      <div className="flex items-center gap-3 p-3 rounded-xl bg-card/40 border border-border/40 shadow-sm">
        <Avatar className="h-8 w-8 shrink-0 border border-primary/30 bg-gradient-to-br from-primary to-primary/60">
      ...
      <div className="space-y-2">
        <p className="section-label px-1">System Status</p>
      ...
      <div className="flex-1 space-y-2 overflow-hidden flex flex-col">
        <p className="section-label px-1">Activity Log</p>
